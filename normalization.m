...
% This function normalises the images to a predefined location given by 
% F_x and F_y in the code.
% The location coordinates data file can be changed in filename variable in the code.
% The databse path of faces can be changed in 'Databsepath' variable in the code
% The save path of faces saved can be changed in 'savepath' variable in the code.
...
while flag
    ...
    F_bar(:,:,2) = F_sum/150; %average of aligned feature locations
